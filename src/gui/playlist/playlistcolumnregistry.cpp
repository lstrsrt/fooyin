...
{
    addDefaultItem({.id = 0, .name = tr("Track"), .field = u"[%disc%.]$num(%track%,2)"_s, .isNumeric = true});
    ...
    addDefaultItem({.id = 7, .name = tr("Duration"), .field = u"%duration%"_s, .isNumeric = true});
    ...
    addDefaultItem({.id = 11, .name = tr("Bitrate"), .field = u"%bitrate% kbps"_s, .isNumeric = true});
    addDefaultItem({.id = 12, .name = tr("Sample Rate"), .field = u"%samplerate% Hz"_s, .isNumeric = true});
    addDefaultItem({.id = 16, .name = tr("Channels"), .field = u"%channels%"_s});
    addDefaultItem({.id = 18, .name = tr("Bit Depth"), .field = u"%bitdepth%"_s, .isNumeric = true});
    addDefaultItem({.id = 17, .name = tr("Last Modified"), .field = u"%lastmodified%"_s});
    addDefaultItem(
        {.id = 6, .name = tr("Playcount"), .field = u"$ifgreater(%playcount%,0,%playcount%)"_s, .isNumeric = true});
