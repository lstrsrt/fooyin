...
const ScriptCommandAliasList& ScriptCommandHandler::scriptCommandAliases()
{
    ...
    static const ScriptCommandAliasList Aliases = {
        ...
        {.alias       = u"previous",
         ...
         .description = "Skip to the previous track"},
        {.alias       = u"playrandom",
         .actionId    = Constants::Actions::RandomTrack,
         .category    = "Playback",
         .description = "Play a random track immediately"},
        {.alias       = u"randomtrack",
         .actionId    = Constants::Actions::RandomTrack,
         .category    = "Playback",
         .description = "Play a random track immediately"},
        {.alias       = u"playrandomalbum",
         .actionId    = Constants::Actions::RandomAlbum,
         .category    = "Playback",
         .description = "Play a random album immediately"},
        {.alias       = u"randomalbum",
         .actionId    = Constants::Actions::RandomAlbum,
         .category    = "Playback",
         .description = "Play a random album immediately"},
        {.alias       = u"playnextalbum",
         .actionId    = Constants::Actions::NextAlbum,
         .category    = "Playback",
         .description = "Play the next album immediately"},
        {.alias       = u"nextalbum",
         .actionId    = Constants::Actions::NextAlbum,
         .category    = "Playback",
         .description = "Play the next album immediately"},
        {.alias       = u"playpreviousalbum",
         .actionId    = Constants::Actions::PreviousAlbum,
         .category    = "Playback",
         .description = "Play the previous album immediately"},
        {.alias       = u"previousalbum",
         .actionId    = Constants::Actions::PreviousAlbum,
         .category    = "Playback",
         .description = "Play the previous album immediately"},
        {.alias       = u"prevalbum",
        ...
        {.alias       = u"clearplaylist",
         .actionId    = Constants::Actions::ClearPlaylist,
         .category    = "Playlist",
