...
const std::vector<ScriptReferenceEntry>& scriptReferenceEntries()
{
    ...
    static const std::vector Entries = {
        ...
        variableEntry("queue_index", tr("Queue"), tr("First playback queue index for the specified item")),
        variableEntry("queue_indexes", tr("Queue"), tr("Playback queue indexes for the specified item")),
        variableEntry("queue_total", tr("Queue"), tr("Total amount of tracks in the playback queue for queued items")),
        ...
        functionEntry("progress", u"$progress(pos,total,length)"_s, tr("Builds a text progress bar"), tr("Utility")),
